...
export default function ListeningQuestion({ prompt, options, onPlayAudio, isAudioPlaying, onAnswer, disabled }: Props) {
    ...
    <View style={styles.container}>
      ...
      {onPlayAudio && (
        <TouchableOpacity style={styles.playButton} onPress={onPlayAudio}>
          ...
          />
          <Text style={styles.playText}>{isAudioPlaying ? 'Playing...' : 'Listen'}</Text>
        </TouchableOpacity>
      )}
